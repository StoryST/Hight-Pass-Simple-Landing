...
/* harmony import */ var _components_yandex_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/yandex-map */ "./src/js/components/yandex-map.js");
/* harmony import */ var _components_yandex_map__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_yandex_map__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_hide_location__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/hide-location */ "./src/js/components/hide-location.js");
/* harmony import */ var _components_hide_location__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_hide_location__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_search_btn__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/search-btn */ "./src/js/components/search-btn.js");
/* harmony import */ var _components_search_btn__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_search_btn__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_validation_about__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/validation-about */ "./src/js/components/validation-about.js");
/* harmony import */ var _components_validation_contacts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/validation-contacts */ "./src/js/components/validation-contacts.js");
...
/***/ "./src/js/components/search-btn.js":
/*!*****************************************!*\
  !*** ./src/js/components/search-btn.js ***!
  \*****************************************/
/***/ (() => {
...
const searchBlock = document.getElementById('header-search-block');
const searchSvg = document.getElementById('search-svg');
const closeBtn = document.getElementById('search-close');
searchBtn.addEventListener('click', () => {
  searchForm.classList.add('show-search');
  searchSvg.classList.add('visually-hidden');
});
closeBtn.addEventListener('click', () => {
  searchForm.classList.remove('show-search');
  searchSvg.classList.remove('visually-hidden');
});
document.addEventListener('click', el => {
  const withinBoundaries = el.composedPath().includes(searchBlock);
  if (!withinBoundaries) {
    searchForm.classList.remove('show-search');
    searchSvg.classList.remove('visually-hidden');
  }
...
/***/ "./src/js/components/validation-about.js":
/*!***********************************************!*\
  !*** ./src/js/components/validation-about.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const rules = [{
  ...
  rules: [{
    rule: 'minLength',
    value: 2,
    errorMessage: 'Имя должно состоять минимум из 2 букв!'
  }, {
    rule: 'required',
    value: true,
  ...
  ruleSelector: '.contacts__input-comment',
  rules: [{
    rule: 'minLength',
    value: 15,
    errorMessage: 'Так мало? Давайте напишем коментарий минимум из 15 символов!'
  }, {
    rule: 'required',
    value: true,
    errorMessage: 'Заполните коментарий!'
  }]
}, {
